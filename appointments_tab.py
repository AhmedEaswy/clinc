...
class AppointmentsTab(QWidget):
    ...
    def init_ui(self):
        ...
        self.table.setHorizontalHeaderLabels(['الرقم', 'المريض', 'الطبيب', 'التاريخ والوقت', 'الحالة', 'ملاحظات'])
    ...
    def load_appointments(self):
        ...
        for row, appointment in enumerate(appointments):
            ...
            self.table.setItem(row, 1, QTableWidgetItem(appointment[8]))  # patient_name
            self.table.setItem(row, 2, QTableWidgetItem(appointment[9]))  # doctor_name
            self.table.setItem(row, 3, QTableWidgetItem(str(appointment[3])))
            self.table.setItem(row, 4, QTableWidgetItem(appointment[4]))
            self.table.setItem(row, 5, QTableWidgetItem(appointment[5]))
    ...
    def add_appointment(self):
        ...
        if dialog.exec_():
            ...
            self.db.add_appointment(patient_id, doctor_id, appointment_date, notes)
            self.load_appointments()
    ...
    def edit_appointment(self):
        ...
        current_notes = self.table.item(row, 5).text()
